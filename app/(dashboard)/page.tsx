...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-zinc-900">{dict.dashboard.title}</h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <p className="text-sm text-zinc-500">{dict.dashboard.openLeads}</p>
          <p className="mt-1 text-3xl font-semibold text-zinc-900">{openLeads.length}</p>
        </Card>
        <Card>
          <p className="text-sm text-zinc-500">{dict.dashboard.upcomingMeetings}</p>
          <p className="mt-1 text-3xl font-semibold text-zinc-900">
            {upcomingMeetings.length}
          </p>
        </Card>
        <Card>
          <p className="text-sm text-zinc-500">{dict.dashboard.openDeals}</p>
          <p className="mt-1 text-3xl font-semibold text-zinc-900">{openDeals.length}</p>
        </Card>
        <Card>
          <p className="text-sm text-zinc-500">{dict.dashboard.wonValue}</p>
          <p className="mt-1 text-3xl font-semibold text-zinc-900">
      ...
      <Card>
        ...
        {soon.length === 0 ? (
          <p className="text-sm text-zinc-500">{dict.dashboard.noMeetingsSoon}</p>
        ) : (
